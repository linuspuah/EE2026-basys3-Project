...
HD_PWD='C:/Users/sunil/desktop/NUS/EE2026/fullv1.0/mouse_oled_audioOut_v3/mouse_oled_audioOut_v3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Student2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Student2.tcl -notrace
